  ...
  return (
    <HomeScreenLayout>
      ...
      <img
        src="/img/Overlay.svg"
        alt="overlay"
        className="pointer-events-none absolute top-0 -left-24 transform scale-125 md:scale-75 md:-left-1/4 md:-top-14"
      />
      <img
        src="/img/Overlay.svg"
        alt="overlay"
        className="pointer-events-none absolute -bottom-2 -right-24 transform scale-125 md:scale-75 md:-right-1/4 md:-bottom-14"
      />
